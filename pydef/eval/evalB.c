...
struct sense_var_struct { acc_struct_t version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct sense_var_struct __attribute__ ((persistent)) var_struct_sense = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; acc_struct_t g_sense; struct lowpass_var_struct { acc_struct_t* version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct lowpass_var_struct __attribute__ ((persistent)) var_struct_lowpass = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; acc_struct_t* g_lowpass; struct median_var_struct { acc_struct_t* version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct median_var_struct __attribute__ ((persistent)) var_struct_median = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; acc_struct_t* g_median; struct classify_var_struct { int version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct classify_var_struct __attribute__ ((persistent)) var_struct_classify = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; int g_classify; struct operate_var_struct { int version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct operate_var_struct __attribute__ ((persistent)) var_struct_operate = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; int g_operate; struct compress_var_struct { acc_struct_t* version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct compress_var_struct __attribute__ ((persistent)) var_struct_compress = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; acc_struct_t* g_compress; struct send_var_struct { int version_array[1 + 1]; short int versions_count; short int window_begin_index; short int write_index; char is_full; }; struct send_var_struct __attribute__ ((persistent)) var_struct_send = {.versions_count = 1, .window_begin_index = 0, .write_index = 0, .is_full = 0}; int g_send;
extern app_struct_t* active_app_array[2]; extern int active_app_count; extern task_struct_t* enabled_task_array[7]; extern int enabled_task_count; extern task_struct_t task_struct_sense;extern task_struct_t task_struct_lowpass;extern task_struct_t task_struct_median;extern task_struct_t task_struct_classify;extern task_struct_t task_struct_operate;extern task_struct_t task_struct_compress;extern task_struct_t task_struct_send;extern app_struct_t app_struct_app_1;extern app_struct_t app_struct_app_2;
...
void sense(){ siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running SENSE\n");
    acc_struct_t sense_out;
    __delay_cycles(40000);
    g_sense = sense_out; var_struct_sense.version_array[var_struct_sense.write_index] = g_sense; var_struct_sense.write_index = (var_struct_sense.write_index + 1) % (var_struct_sense.versions_count + 1); if(var_struct_sense.is_full){ var_struct_sense.window_begin_index = (var_struct_sense.window_begin_index + 1) % (var_struct_sense.versions_count + 1); } else if(var_struct_sense.write_index == 0){ var_struct_sense.is_full = 1; var_struct_sense.window_begin_index = (var_struct_sense.window_begin_index + 1) % (var_struct_sense.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, sense\n", delta_cycles); if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_sense.deadline[!task_struct_sense.deadlineVersion & 0x1] = 666666; task_struct_sense.deadlineVersion = !task_struct_sense.deadlineVersion & 0x1;}extern task_struct_t task_struct_lowpass; short int task_struct_lowpass_enVersion = task_struct_lowpass.isEnabledVersion; if(!(task_struct_lowpass.isEnabled[task_struct_lowpass_enVersion]) && (app_struct_app_1.isActive[app_struct_app_1.isActiveVersion])){ task_struct_lowpass.isEnabled[!task_struct_lowpass_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_lowpass; enabled_task_count++; task_struct_lowpass.isEnabledVersion = !task_struct_lowpass_enVersion & 0x1; if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_lowpass.deadline[!task_struct_lowpass.deadlineVersion & 0x1] = task_struct_sense.deadline[!task_struct_sense.deadlineVersion & 0x1]; task_struct_lowpass.deadlineVersion = !task_struct_lowpass.deadlineVersion & 0x1;} }
}

void lowpass(){ acc_struct_t sense = g_sense; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running LOWPASS\n");
    acc_struct_t* lowpass_out;
    __delay_cycles(25000);
    g_lowpass = lowpass_out; var_struct_lowpass.version_array[var_struct_lowpass.write_index] = g_lowpass; var_struct_lowpass.write_index = (var_struct_lowpass.write_index + 1) % (var_struct_lowpass.versions_count + 1); if(var_struct_lowpass.is_full){ var_struct_lowpass.window_begin_index = (var_struct_lowpass.window_begin_index + 1) % (var_struct_lowpass.versions_count + 1); } else if(var_struct_lowpass.write_index == 0){ var_struct_lowpass.is_full = 1; var_struct_lowpass.window_begin_index = (var_struct_lowpass.window_begin_index + 1) % (var_struct_lowpass.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, lowpass\n", delta_cycles); if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_lowpass.deadline[!task_struct_lowpass.deadlineVersion & 0x1] = task_struct_sense.deadline[task_struct_sense.deadlineVersion]; task_struct_lowpass.deadlineVersion = !task_struct_lowpass.deadlineVersion & 0x1;}extern task_struct_t task_struct_median; short int task_struct_median_enVersion = task_struct_median.isEnabledVersion; if(!(task_struct_median.isEnabled[task_struct_median_enVersion]) && (app_struct_app_1.isActive[app_struct_app_1.isActiveVersion])){ task_struct_median.isEnabled[!task_struct_median_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_median; enabled_task_count++; task_struct_median.isEnabledVersion = !task_struct_median_enVersion & 0x1; if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_median.deadline[!task_struct_median.deadlineVersion & 0x1] = task_struct_lowpass.deadline[!task_struct_lowpass.deadlineVersion & 0x1]; task_struct_median.deadlineVersion = !task_struct_median.deadlineVersion & 0x1;} }
}

void median(){ acc_struct_t* lowpass = g_lowpass; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running MEDIAN\n");
    acc_struct_t* median_out;
    __delay_cycles(25000);
    g_median = median_out; var_struct_median.version_array[var_struct_median.write_index] = g_median; var_struct_median.write_index = (var_struct_median.write_index + 1) % (var_struct_median.versions_count + 1); if(var_struct_median.is_full){ var_struct_median.window_begin_index = (var_struct_median.window_begin_index + 1) % (var_struct_median.versions_count + 1); } else if(var_struct_median.write_index == 0){ var_struct_median.is_full = 1; var_struct_median.window_begin_index = (var_struct_median.window_begin_index + 1) % (var_struct_median.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, median\n", delta_cycles); if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_median.deadline[!task_struct_median.deadlineVersion & 0x1] = task_struct_lowpass.deadline[task_struct_lowpass.deadlineVersion]; task_struct_median.deadlineVersion = !task_struct_median.deadlineVersion & 0x1;}extern task_struct_t task_struct_classify; short int task_struct_classify_enVersion = task_struct_classify.isEnabledVersion; if(!(task_struct_classify.isEnabled[task_struct_classify_enVersion]) && (app_struct_app_1.isActive[app_struct_app_1.isActiveVersion])){ task_struct_classify.isEnabled[!task_struct_classify_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_classify; enabled_task_count++; task_struct_classify.isEnabledVersion = !task_struct_classify_enVersion & 0x1; if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_classify.deadline[!task_struct_classify.deadlineVersion & 0x1] = task_struct_median.deadline[!task_struct_median.deadlineVersion & 0x1]; task_struct_classify.deadlineVersion = !task_struct_classify.deadlineVersion & 0x1;} } extern task_struct_t task_struct_compress; short int task_struct_compress_enVersion = task_struct_compress.isEnabledVersion; if(!(task_struct_compress.isEnabled[task_struct_compress_enVersion]) && (app_struct_app_2.isActive[app_struct_app_2.isActiveVersion])){ task_struct_compress.isEnabled[!task_struct_compress_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_compress; enabled_task_count++; task_struct_compress.isEnabledVersion = !task_struct_compress_enVersion & 0x1; if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_compress.deadline[!task_struct_compress.deadlineVersion & 0x1] = 2000000; task_struct_compress.deadlineVersion = !task_struct_compress.deadlineVersion & 0x1;} }
}

void classify(){ acc_struct_t* median = g_median; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running CLASSIFY\n");
    int classify_out;
    __delay_cycles(40000);
    g_classify = classify_out; var_struct_classify.version_array[var_struct_classify.write_index] = g_classify; var_struct_classify.write_index = (var_struct_classify.write_index + 1) % (var_struct_classify.versions_count + 1); if(var_struct_classify.is_full){ var_struct_classify.window_begin_index = (var_struct_classify.window_begin_index + 1) % (var_struct_classify.versions_count + 1); } else if(var_struct_classify.write_index == 0){ var_struct_classify.is_full = 1; var_struct_classify.window_begin_index = (var_struct_classify.window_begin_index + 1) % (var_struct_classify.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, classify\n", delta_cycles); if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_classify.deadline[!task_struct_classify.deadlineVersion & 0x1] = task_struct_median.deadline[task_struct_median.deadlineVersion]; task_struct_classify.deadlineVersion = !task_struct_classify.deadlineVersion & 0x1;}extern task_struct_t task_struct_operate; short int task_struct_operate_enVersion = task_struct_operate.isEnabledVersion; if(!(task_struct_operate.isEnabled[task_struct_operate_enVersion]) && (app_struct_app_1.isActive[app_struct_app_1.isActiveVersion])){ task_struct_operate.isEnabled[!task_struct_operate_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_operate; enabled_task_count++; task_struct_operate.isEnabledVersion = !task_struct_operate_enVersion & 0x1; if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_operate.deadline[!task_struct_operate.deadlineVersion & 0x1] = task_struct_classify.deadline[!task_struct_classify.deadlineVersion & 0x1]; task_struct_operate.deadlineVersion = !task_struct_operate.deadlineVersion & 0x1;} }
}

void operate(){ int classify = g_classify; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running OPERATE\n");
    int operate_out;
    __delay_cycles(30000);
    siren_command("LOG_EVENT: app 1 END\n");
    g_operate = operate_out; var_struct_operate.version_array[var_struct_operate.write_index] = g_operate; var_struct_operate.write_index = (var_struct_operate.write_index + 1) % (var_struct_operate.versions_count + 1); if(var_struct_operate.is_full){ var_struct_operate.window_begin_index = (var_struct_operate.window_begin_index + 1) % (var_struct_operate.versions_count + 1); } else if(var_struct_operate.write_index == 0){ var_struct_operate.is_full = 1; var_struct_operate.window_begin_index = (var_struct_operate.window_begin_index + 1) % (var_struct_operate.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, operate\n", delta_cycles); unsigned long int value = 333333 - task_struct_operate.deadline[task_struct_operate.deadlineVersion] - delta_cycles; siren_command("PRINTF: updating tput aftrer operate\n"); if (value < 0){ siren_command("PRINTF: underperforming\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = -1; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } else if (value > 0) { siren_command("PRINTF: overperforming\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = 1; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } else { siren_command("PRINTF: performance ok\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = 0; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_operate.deadline[!task_struct_operate.deadlineVersion & 0x1] = task_struct_classify.deadline[task_struct_classify.deadlineVersion]; task_struct_operate.deadlineVersion = !task_struct_operate.deadlineVersion & 0x1;}
}

void compress(){ acc_struct_t* median = g_median; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running COMPRESS\n");
    int compress_out;
    __delay_cycles(40000);
    g_compress = compress_out; var_struct_compress.version_array[var_struct_compress.write_index] = g_compress; var_struct_compress.write_index = (var_struct_compress.write_index + 1) % (var_struct_compress.versions_count + 1); if(var_struct_compress.is_full){ var_struct_compress.window_begin_index = (var_struct_compress.window_begin_index + 1) % (var_struct_compress.versions_count + 1); } else if(var_struct_compress.write_index == 0){ var_struct_compress.is_full = 1; var_struct_compress.window_begin_index = (var_struct_compress.window_begin_index + 1) % (var_struct_compress.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, compress\n", delta_cycles); if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_compress.deadline[!task_struct_compress.deadlineVersion & 0x1] = 2000000; task_struct_compress.deadlineVersion = !task_struct_compress.deadlineVersion & 0x1;}extern task_struct_t task_struct_send; short int task_struct_send_enVersion = task_struct_send.isEnabledVersion; if(!(task_struct_send.isEnabled[task_struct_send_enVersion]) && (app_struct_app_2.isActive[app_struct_app_2.isActiveVersion])){ task_struct_send.isEnabled[!task_struct_send_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_send; enabled_task_count++; task_struct_send.isEnabledVersion = !task_struct_send_enVersion & 0x1; if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_send.deadline[!task_struct_send.deadlineVersion & 0x1] = task_struct_compress.deadline[!task_struct_compress.deadlineVersion & 0x1]; task_struct_send.deadlineVersion = !task_struct_send.deadlineVersion & 0x1;} }
}

void send(){ acc_struct_t* compress = g_compress; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running SEND\n");
    int send_out;
    __delay_cycles(50000);
    siren_command("LOG_EVENT: app 2 END\n");
    g_send = send_out; var_struct_send.version_array[var_struct_send.write_index] = g_send; var_struct_send.write_index = (var_struct_send.write_index + 1) % (var_struct_send.versions_count + 1); if(var_struct_send.is_full){ var_struct_send.window_begin_index = (var_struct_send.window_begin_index + 1) % (var_struct_send.versions_count + 1); } else if(var_struct_send.write_index == 0){ var_struct_send.is_full = 1; var_struct_send.window_begin_index = (var_struct_send.window_begin_index + 1) % (var_struct_send.versions_count + 1); } siren_command("GET_CCOUNT: task-%l\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %l, send\n", delta_cycles); unsigned long int value = 1000000 - task_struct_send.deadline[task_struct_send.deadlineVersion] - delta_cycles; siren_command("PRINTF: updating tput aftrer send\n"); if (value < 0){ siren_command("PRINTF: underperforming\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = -1; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } else if (value > 0) { siren_command("PRINTF: overperforming\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = 1; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } else { siren_command("PRINTF: performance ok\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = 0; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_send.deadline[!task_struct_send.deadlineVersion & 0x1] = task_struct_compress.deadline[task_struct_compress.deadlineVersion]; task_struct_send.deadlineVersion = !task_struct_send.deadlineVersion & 0x1;}
}

task_struct_t __attribute__ ((persistent)) task_struct_sense = {.e_wc = 80, .in_set = {}, .in_set_count = 0, .function_pointer = &sense, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_lowpass = {.e_wc = 25, .in_set = {&task_struct_sense}, .in_set_count = 1, .function_pointer = &lowpass, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_median = {.e_wc = 25, .in_set = {&task_struct_lowpass}, .in_set_count = 1, .function_pointer = &median, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_compress = {.e_wc = 40, .in_set = {&task_struct_median}, .in_set_count = 1, .function_pointer = &compress, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_send = {.e_wc = 50, .in_set = {&task_struct_compress}, .in_set_count = 1, .function_pointer = &send, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_classify = {.e_wc = 40, .in_set = {&task_struct_median}, .in_set_count = 1, .function_pointer = &classify, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_operate = {.e_wc = 30, .in_set = {&task_struct_classify}, .in_set_count = 1, .function_pointer = &operate, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0};
task_struct_t* __attribute__ ((persistent)) task_array[7] = {&task_struct_sense, &task_struct_lowpass, &task_struct_median, &task_struct_classify, &task_struct_operate, &task_struct_compress, &task_struct_send}; task_struct_t* __attribute__ ((persistent)) active_task_array[7] = {}; int __attribute__ ((persistent)) active_task_count = 0; task_struct_t* __attribute__ ((persistent)) enabled_task_array[7] = {}; int __attribute__ ((persistent)) enabled_task_count = 0;
app_struct_t __attribute__ ((persistent)) app_struct_app_1 = {.x_min = 333333, .x_ok = {0,0}, .x_okVersion = 0x0, .tasks_count = 5, .app_tasks = {&task_struct_sense, &task_struct_lowpass, &task_struct_median, &task_struct_classify, &task_struct_operate}, .initial_task = &task_struct_sense, .final_task = &task_struct_operate, .isActive = {0x0, 0x0}, .isActiveVersion = 0x0}; app_struct_t __attribute__ ((persistent)) app_struct_app_2 = {.x_min = 1000000, .x_ok = {0,0}, .x_okVersion = 0x0, .tasks_count = 2, .app_tasks = {&task_struct_compress, &task_struct_send}, .initial_task = &task_struct_compress, .final_task = &task_struct_send, .isActive = {0x0, 0x0}, .isActiveVersion = 0x0};
...
void scheduler(){
    ...
    while(1){
        ...
        siren_command("PRINTF: lowpass[%l,%l] version=%u\n", task_struct_lowpass.deadline[0],task_struct_lowpass.deadline[1]);
        ...
        while(selection < enabled_task_count && exec_depth<=(enabled_task_array[selection]->e_wc) * 10) selection++;
