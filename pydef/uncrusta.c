...
void task_1(){ siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running task 1\n");
    int t1_out;
    t1_out = get_sample();
    g_task_1 = t1_out; var_struct_task_1.version_array[var_struct_task_1.write_index] = g_task_1; var_struct_task_1.write_index = (var_struct_task_1.write_index + 1) % (var_struct_task_1.versions_count + 1); if(var_struct_task_1.is_full){ var_struct_task_1.window_begin_index = (var_struct_task_1.window_begin_index + 1) % (var_struct_task_1.versions_count + 1); } else if(var_struct_task_1.write_index == 0){ var_struct_task_1.is_full = 1; var_struct_task_1.window_begin_index = (var_struct_task_1.window_begin_index + 1) % (var_struct_task_1.versions_count + 1); } siren_command("GET_CCOUNT: task-%u\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %u\n", delta_cycles); extern task_struct_t task_struct_task_2; short int task_struct_task_2_enVersion = task_struct_task_2.isEnabledVersion; if(!(task_struct_task_2.isEnabled[task_struct_task_2_enVersion]) && (app_struct_app_1.isActive[app_struct_app_1.isActiveVersion])){ task_struct_task_2.isEnabled[!task_struct_task_2_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_task_2; enabled_task_count++; task_struct_task_2.isEnabledVersion = !task_struct_task_2_enVersion & 0x1; if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_task_2.deadline[!task_struct_task_2.deadlineVersion & 0x1] = 333333; task_struct_task_2.deadlineVersion = !task_struct_task_2.deadlineVersion & 0x1;} } extern task_struct_t task_struct_task_3; short int task_struct_task_3_enVersion = task_struct_task_3.isEnabledVersion; if(!(task_struct_task_3.isEnabled[task_struct_task_3_enVersion]) && (app_struct_app_2.isActive[app_struct_app_2.isActiveVersion])){ task_struct_task_3.isEnabled[!task_struct_task_3_enVersion & 0x1] |= 0x1; enabled_task_array[enabled_task_count] = &task_struct_task_3; enabled_task_count++; task_struct_task_3.isEnabledVersion = !task_struct_task_3_enVersion & 0x1; if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_task_3.deadline[!task_struct_task_3.deadlineVersion & 0x1] = 1000000; task_struct_task_3.deadlineVersion = !task_struct_task_3.deadlineVersion & 0x1;} } if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_task_1.deadline[!task_struct_task_1.deadlineVersion & 0x1] = 333333; task_struct_task_1.deadlineVersion = !task_struct_task_1.deadlineVersion & 0x1;}else if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_task_1.deadline[!task_struct_task_1.deadlineVersion & 0x1] = 1000000; task_struct_task_1.deadlineVersion = !task_struct_task_1.deadlineVersion & 0x1;}
}

void task_2(){ int task_1 = g_task_1; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running task 2\n");
    int t2_output;
    t2_output = task_1 + 10;
    siren_command("LOG_EVENT: end app1\n");
    g_task_2 = t2_output; var_struct_task_2.version_array[var_struct_task_2.write_index] = g_task_2; var_struct_task_2.write_index = (var_struct_task_2.write_index + 1) % (var_struct_task_2.versions_count + 1); if(var_struct_task_2.is_full){ var_struct_task_2.window_begin_index = (var_struct_task_2.window_begin_index + 1) % (var_struct_task_2.versions_count + 1); } else if(var_struct_task_2.write_index == 0){ var_struct_task_2.is_full = 1; var_struct_task_2.window_begin_index = (var_struct_task_2.window_begin_index + 1) % (var_struct_task_2.versions_count + 1); } siren_command("GET_CCOUNT: task-%u\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %u\n", delta_cycles); unsigned long int value = 333333 - task_struct_task_2.deadline[task_struct_task_2.deadlineVersion] - delta_cycles; siren_command("PRINTF: updating tput aftrer task_2\n"); if (value < 0){ siren_command("PRINTF: underperforming\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = -1; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } else if (value > 0) { siren_command("PRINTF: overperforming\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = 1; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } else { siren_command("PRINTF: performance ok\n"); app_struct_app_1.x_ok[!app_struct_app_1.x_okVersion & 0x1] = 0; app_struct_app_1.x_okVersion = !app_struct_app_1.x_okVersion & 0x1; } if(app_struct_app_1.isActive[app_struct_app_1.isActiveVersion]) { task_struct_task_2.deadline[!task_struct_task_2.deadlineVersion & 0x1] = 333333; task_struct_task_2.deadlineVersion = !task_struct_task_2.deadlineVersion & 0x1;}
}

void task_3(){ int task_1 = g_task_1; siren_command("START_CCOUNT: task\n");
    siren_command("PRINTF: running task 3\n");
    int t3_output;
    t3_output = task_1 * 10;
    siren_command("LOG_EVENT: end app2\n");
    g_task_3 = t3_output; var_struct_task_3.version_array[var_struct_task_3.write_index] = g_task_3; var_struct_task_3.write_index = (var_struct_task_3.write_index + 1) % (var_struct_task_3.versions_count + 1); if(var_struct_task_3.is_full){ var_struct_task_3.window_begin_index = (var_struct_task_3.window_begin_index + 1) % (var_struct_task_3.versions_count + 1); } else if(var_struct_task_3.write_index == 0){ var_struct_task_3.is_full = 1; var_struct_task_3.window_begin_index = (var_struct_task_3.window_begin_index + 1) % (var_struct_task_3.versions_count + 1); } siren_command("GET_CCOUNT: task-%u\n", &delta_cycles); siren_command("TEST_EXECUTION_CCOUNT: %u\n", delta_cycles); unsigned long int value = 1000000 - task_struct_task_3.deadline[task_struct_task_3.deadlineVersion] - delta_cycles; siren_command("PRINTF: updating tput aftrer task_3\n"); if (value < 0){ siren_command("PRINTF: underperforming\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = -1; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } else if (value > 0) { siren_command("PRINTF: overperforming\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = 1; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } else { siren_command("PRINTF: performance ok\n"); app_struct_app_2.x_ok[!app_struct_app_2.x_okVersion & 0x1] = 0; app_struct_app_2.x_okVersion = !app_struct_app_2.x_okVersion & 0x1; } if(app_struct_app_2.isActive[app_struct_app_2.isActiveVersion]) { task_struct_task_3.deadline[!task_struct_task_3.deadlineVersion & 0x1] = 1000000; task_struct_task_3.deadlineVersion = !task_struct_task_3.deadlineVersion & 0x1;}
}

task_struct_t __attribute__ ((persistent)) task_struct_task_1 = {.e_wc = 450, .in_set = {}, .in_set_count = 0, .function_pointer = &task_1, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_task_3 = {.e_wc = 250, .in_set = {&task_struct_task_1}, .in_set_count = 1, .function_pointer = &task_3, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0}; task_struct_t __attribute__ ((persistent)) task_struct_task_2 = {.e_wc = 150, .in_set = {&task_struct_task_1}, .in_set_count = 1, .function_pointer = &task_2, .isEnabled = {0x0,0x0}, .isEnabledVersion = 0x0, .isActive = {0x0,0x0}, .isActiveVersion = 0x0, .deadlineVersion = 0x0};
...
app_struct_t __attribute__ ((persistent)) app_struct_app_1 = {.x_min = 333333, .x_ok = {0,0}, .x_okVersion = 0x0, .tasks_count = 2, .app_tasks = {&task_struct_task_1, &task_struct_task_2}, .initial_task = &task_struct_task_1, .final_task = &task_struct_task_2, .isActive = {0x0, 0x0}, .isActiveVersion = 0x0}; app_struct_t __attribute__ ((persistent)) app_struct_app_2 = {.x_min = 1000000, .x_ok = {0,0}, .x_okVersion = 0x0, .tasks_count = 2, .app_tasks = {&task_struct_task_1, &task_struct_task_3}, .initial_task = &task_struct_task_1, .final_task = &task_struct_task_3, .isActive = {0x0, 0x0}, .isActiveVersion = 0x0};
app_struct_t* __attribute__ ((persistent)) app_array[2] = {&app_struct_app_2, &app_struct_app_1}; app_struct_t* __attribute__ ((persistent)) active_app_array[2] = {}; int __attribute__ ((persistent)) active_app_count = 0;
